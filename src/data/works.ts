...
export const WORKS: Work[] = [
  ...
  },
  {
    ...
    title: '鄉間小路與多愁善感的姊姊',
    category: ['script', 'creation'],
    description: '女孩等著自己兩年不見的弟弟回家，人跟景物實在變化太大，女孩不禁放聲哭泣了起來。',
  ...
  },
  {
    ...
    title: '我才是最特別的納一位',
    category: 'commission',
    description: '情人節到了，與人妻納老婆納一起做巧克力吧！',
  ...
  },
  {
    ...
    title: '鼠在不想離開你',
    category: 'commission',
    description: '情人節吃醋的學生，翹課來保健室找老師尋求陪伴時發生的一連串意外。',
  ...
  },
  {
    ...
    title: '我們的事',
    category: 'creation',
    description: '希望你不管發生什麼事，都能夠有勇氣、有力量治癒自己。',
  ...
  },
  {
    ...
    category: 'commission',
    description: '從與小雪初探身體交織到美好，進展到小雪習慣且占有老公對其身心靈的愛。\n（Project:雪白薄紗｜Voice:小雪Yukichan｜Script:卡蚯蚓）',
  ...
  {
    id: 27,
    title: '將尾巴與月色借你，直到雪夜放晴',
    category: 'commission',
    description: '豹崽子向 Vivy 打聽塞壬之歌的情報，卻意外踩到 Vivy 的雷。經過一番爭執與拉扯才發現是場誤會，於是兩人重修舊好，甚至感情更加深厚。\n（Project:雪白薄紗｜Voice:名雪薇薇｜Script:卡蚯蚓）',
    image: '/work_pic/work_tailmoon.jpg',
    brandId: 'kacha',
  },
];
